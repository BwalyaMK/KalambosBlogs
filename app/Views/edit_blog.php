...
<head>
    ...
    <title>Edit Blog <?= esc($blog['id']) ?></title>
...
<body>
    ...
    <form action="/dashboard/updateBlog/<?= esc($blog['id']) ?>" method="post">
        <?= csrf_field() ?>

        <div>
            <label for="title">Blog Title:</label>
            <input type="text" name="title" id="title" value="<?= esc($blog['title']) ?>" required>
        </div>
